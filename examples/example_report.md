...
**Figure:** `fault_progression.png` — Panel A, drive-end PSD 0–300 Hz across the four sessions with BPFO harmonics marked; Panel B, fault indicators (2×/3×BPFO amplitude, DE bearing temperature, overall vibration) versus session.
